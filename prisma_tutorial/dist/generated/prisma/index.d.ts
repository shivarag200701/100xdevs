...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "username" | "firstname" | "lastname" | "password", ExtArgs["result"]["user"]>
  ...
  export type TodosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "done" | "user_id", ExtArgs["result"]["todos"]>
  ...
  interface TodosFieldRefs {
    ...
    readonly done: FieldRef<"Todos", 'Boolean'>
  ...
  export type TodosScalarWhereWithAggregatesInput = {
    ...
    done?: BoolWithAggregatesFilter<"Todos"> | boolean
